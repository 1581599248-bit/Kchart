"""Production analysis adapter for the investment-grade v12 engine."""
from __future__ import annotations

from . import investment_engine_v12 as engine

ANALYSIS_VERSION = "analysis_v12.0-investment-grade"
