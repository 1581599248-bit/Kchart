...
from backend.app import indicators, reversal_patterns_v11
...
def main() -> None:
    df = fetch_df()
    events = reversal_patterns_v11.find_index_reversals(df)
    ...
    # 真实最新M顶：4258.86—3927.85—4175.35，2026-07-17确认。
    ...
    print("live reversal v11 validation OK")
